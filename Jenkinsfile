...
node(){
        ...
        stage('preparation') {
                ...
                DOCKER_CMD = "docker run --network="host" --rm -v $WORKSPACE/testResults:${pwd()}/reports -w ${pwd()} ibombit/lighthouse-puppeteer-chrome:latest node training_app_perfomance.js"

...
node(){
        ...
        stage('preparation') {
                ...
                DOCKER_CMD = "docker run --rm -v $WORKSPACE/testResults:${pwd()}/reports -v ${pwd()}:${pwd()} -w ${pwd()} ibombit/lighthouse-puppeteer-chrome:latest node training_app_performance.js"
